...
import d from './d.png';
import inbox2 from './inbox2.png';
import starred2 from './starred2.png'
function Starred() {
    ...
    {folderListVisible && !folderList.length && <div className="no-folders">No Folders found</div>}
        ...
        <div className={requestListVisible ? "requestList" : "request-list hidden"} id="requestList">
            ...
            <div className="search-container">
                ...
                <div className="twentysevena"><img src={starredicon} alt="inbox" width={25} height={25}/></div>
                ...
                <img src={starred2} alt="nomessage" width={180} height={180}/></div>
