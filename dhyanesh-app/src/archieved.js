...
import d from './d.png';
import archieved2 from './archieve2.png';
function Archieved() {
    ...
    {folderListVisible && !folderList.length && <div className="no-folders">No Folders found</div>}
        ...
        <div className={requestListVisible ? "requestList" : "request-list hidden"} id="requestList">
            ...
            <div className="search-container">
                ...
                <div className="twentysevena"><img src={archieveicon} alt="sent" width={25} height={25}/></div>
                ...
                <img src={archieved2} alt="nomessage" width={180} height={180}/></div>
