...
import d from './d.png';
import allmail2 from './allmail2.png';
function Allmail() {
    ...
    {folderListVisible && !folderList.length && <div className="no-folders">No Folders found</div>}
        ...
        <div className={requestListVisible ? "requestList" : "request-list hidden"} id="requestList">
            ...
            <div className="search-container">
                ...
                <div className="twentysevena"><img src={allmailicon} alt="inbox" width={35} height={35}/></div>
                ...
                <img src={allmail2} alt="nomessage" width={180} height={180}/></div>
